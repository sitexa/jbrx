 ...
 * 用户上传平台表
 */
public class UploadUserPlatform implements Serializable {
    ...
    public UploadUserPlatform() {
    }

    public UploadUserPlatform(Long id, Long platformId, Long userId, String name, Long day, String descx, String investMoney, String shareMoney, String url, Integer status, String createTime, String updateTime) {
        this.id = id;
