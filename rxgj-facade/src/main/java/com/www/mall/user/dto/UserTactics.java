...
public class UserTactics implements Serializable {
    ...
    public UserTactics(Long id,Long userId,Long day, Long tacticsId, Long platformId, String tacticsSn, String name, String minRate, String maxRate, String topRisk, Integer status, String createTime, String updateTime) {
        this.id = id;
