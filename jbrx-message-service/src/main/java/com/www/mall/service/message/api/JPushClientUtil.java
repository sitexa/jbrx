...
public class JPushClientUtil {
	private final static String appKey = "31e4cbe1d36d11bc10baa2c2";

	private final static String masterSecret = "df5edbaa1e67582f6f0ef72e";
	...
	public static void main(String[] args) {
		if (JPushClientUtil.sendToAllAndroid("测试不要脸", "妈卖批", "www.baidu.com", "") == 1) {
