...
public class UserPlatform implements Serializable {
    ...
    public UserPlatform(Long id, Long platformId, Long userId, String name, Long day, String descx, String investMoney, String shareMoney, String url, Integer status, String createTime, String updateTime) {
        this.id = id;
