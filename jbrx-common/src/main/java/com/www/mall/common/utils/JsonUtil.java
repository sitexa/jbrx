...
public class JsonUtil {
	 ...
	 * 
	 * @param xmlString
	 *            XML字符串 例如： <?xml version='1.0'
	 *            encoding='utf-8'?><cities><province name=
	 ...
	 *            生成文件存放的路径
	 * @param flag
	 *            true:JSON 转为 XML false:XML转为 JSON
	 * @return
	 */
	...
	public static void main(String[] args) {
		...
		// System.out.println(xml2json("<?xml version='1.0'
		// encoding='utf-8'?><cities><province
